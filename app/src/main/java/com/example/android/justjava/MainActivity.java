...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LOCALECODE ="LocaleCode" ;
    int quantity = 2;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //after each rotation, read the saved locale information and set it.
        if (savedInstanceState != null) {
            mLocale = savedInstanceState.getString(LOCALECODE, "en");
            Log.v("MainActivity", "mLocal is: " + mLocale);
        } else {
            mLocale = "en";
        }
        changeLocale(mLocale);
    ...
    switch (item.getItemId()) {
        case R.id.chinese:
            //Log.v("MainActivity","+++++select Chinese lang+++++");
            changeLocale("zh");
            return true;
        case R.id.spanish:
            //Log.v("MainActivity", "++++ select Spanish lang++++");
            changeLocale("es");
            return true;
        case R.id.english:
            //Log.v("MainActivity","+++++ select English lang +++++");
            changeLocale("en");
            return true;
        default:
    ...
    public void submitOrder(View view) {
        ...
        sendOrderSummaryByEmail(name,message);
     ...
     */
    private void displayOrderSummary(String msg) {
        TextView orderSummaryTextView = (TextView) findViewById(
                R.id.orderSummary);
        orderSummaryTextView.setText(msg);
    }

    private void sendOrderSummaryByEmail(String name, String message) {
    ...
    private void changeLocale(String languageToLoad) {
        ...
        //Log.v("MainActivity","Change and save locale to: "+locale.toString());
        getBaseContext().getResources().updateConfiguration(config,
                getBaseContext().getResources().getDisplayMetrics());
        this.setContentView(R.layout.activity_main);
        mLocale = languageToLoad;
    }

    @Override
    public void onSaveInstanceState(Bundle savedInstanceState) {
        //Log.v("MainActivity","onSaveInstanceState called");
        savedInstanceState.putString(LOCALECODE,mLocale);
    }

    @Override
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        //Log.v("MainActivity","onRestoreInstanceState called");
        mLocale = savedInstanceState.getString(LOCALECODE, "en");
    }
